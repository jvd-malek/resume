        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div class="text-center lg:text-left max-w-2xl">
            ...
            <div class="flex flex-wrap gap-4 justify-center lg:justify-start animate-fade-in-up" style="animation-delay: 0.4s">
              ...
              <a href="${getLang() === 'fa' ? '/resume-fa.html' : '/resume-en.html'}" target="_blank" class="resume-btn px-8 py-3 border-2 border-gray-600 text-gray-300 font-medium rounded-xl hover:border-primary hover:text-primary transition-all duration-300 flex items-center gap-2">
                <span>📄</span>
        ...
        <div class="grid md:grid-cols-5 gap-8">
          ...
          <div class="md:col-span-2 space-y-6 section-hidden" data-animate>
            ...
            <div class="glass rounded-2xl p-6">
              ...
              <a href="${getLang() === 'fa' ? '/resume-fa.html' : '/resume-en.html'}" target="_blank" class="resume-btn flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-primary to-accent text-white hover:shadow-lg hover:shadow-primary/30 transition-all text-xs font-medium mt-3">
                <span>📄</span>
                <span>${t('hero.cta3')}</span>
              </a>
            </div>
